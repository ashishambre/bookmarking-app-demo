...
public class DataStore {
	...
	public static Bookmark[][] bookmarks = new Bookmark[BOOKMARKS_TYPE_COUNT][BOOKMARK_COUNT_PER_TYPE];
	...
	private static void loadBooks() {
		...
		bookmarks[2][2] = BookmarkManager.getInstance().createBook(4002, "Light From Many Lamps", "", 1988,
				"Touchstone	Lillian", new String[] { "Eichler Watson" }, BookGenre.PHILOSOPHY, 5.0);
